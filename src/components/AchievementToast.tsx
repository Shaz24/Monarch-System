  ...
  toast.custom(
    (t: Toast) => (
      <motion.div
        ...
        className="max-w-md w-full bg-void border-2 border-[#FFD700] shadow-[0_0_20px_rgba(255,215,0,0.3)] pointer-events-auto flex items-center p-4 gap-4 cursor-pointer select-none"
      >
